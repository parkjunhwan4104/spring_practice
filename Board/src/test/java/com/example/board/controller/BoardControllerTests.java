...
public class BoardControllerTests {
	...
	public void listTest() throws Exception {
		log.info(mockMvc.perform(MockMvcRequestBuilders.get("/board/list").param("pageNum", "308").param("amount", "10")).andReturn().getModelAndView().getModelMap());  //MockMvcRequestBuilders:요청을 할 수 있게끔 하는 거, andReturn(): 요청을 하고나서 결과들을 가져오는 객체, getModelAndView(): 현재 모델이란 객체에 뭐가 들어있는지 보여주는거

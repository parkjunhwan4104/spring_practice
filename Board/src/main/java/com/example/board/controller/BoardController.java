...
public class BoardController {
	...
	public String register(BoardDTO boardDTO,RedirectAttributes rttr ,Model model) {
		...
		rttr.addFlashAttribute("bno",boardDTO.getBno()); //기존 모델 객체를 이용할떄는 redirect할때 reqeustScope가 없어져서 데이터를 전달할 수 없었지만
